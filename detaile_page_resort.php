...
$id = $_GET['id'];
$query = "SELECT * FROM resort_info WHERE id = '$id' ";
...
$comment_id = $_GET['id'];
$sql2 = "SELECT * FROM comment_resort WHERE id = '$comment_id'";
...
if (isset($_POST['comment_submit'])) {
    ...
    $con = mysqli_connect("localhost", "root", "", "hotel");
    $query = "INSERT INTO comment_resort(id,uid,message) VALUES ('" . $comment_id . "','" . $uid . "','" . $message . "')";
...
<body class="">
    ...
    <h2 class="text-center">Resort Details Description Page</h2>
    <div class="row gy-3">
      <!-- manually change gutter using g{d}-{n} -->
      <div class="col-sm-4 col-lg-6">
        <?php echo '<img class = "img-fluid" style = "width: 400;" src="data:image;base64,' . base64_encode($result['resort_image']) . '">'; ?>
        <!-- <p class="display-5 fw-bold">Name of the hotel</p> -->

        <p class="fw-bold display-4 ">
          <?php echo $result['resort_name']; ?>
        </p>
        <p class="fw-bold ">Description about
          <?php echo $result['resort_name']; ?>
        </p>
        <p class="comment_class">
          <?php echo $result['resort_description']; ?>
        </p>
      </div>
      ...
      <div class="col-sm-4 col-lg-6">
        ...
        <p>
          <?php echo $result['resort_services']; ?>
        </p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 item text">
                        ...
                        <p>Tourism has a few major elements − destinations, attractions, sites, accommodation, and all
                            ancillary services. The need for a robust and dynamic tour management application has been
                            around since the advent of the tourism concept. Thus we have developed an application to
                            provide the best travelling services to the customers and travel agents. The Tourism
                            Management System provides a search platform where a tourist
